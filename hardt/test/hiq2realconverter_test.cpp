...
private:
    ...
    void test_converter_as_writer()
    {
        ...
        int8_t expected[4] = {2, 3, 6, 4};

        TestWriter<int8_t > wr("hiq2realconverter_test_testwriter", 16);
        HIq2RealConverter<int8_t> converter("hiq2realconverter_test_as_writer", wr.Writer(), 8);
    ...
    void test_converter_as_consumer()
    {
        ...
        TestWriter<int8_t> srcWr("hiq2realconverter_test_testwriter_src", 8);
        HIq2RealConverter<int8_t> converter("hiq2realconverter_test_as_consumer", srcWr.Consumer(), 8);
        TestWriter<int8_t > wr("hiq2realconverter_test_testwriter_wr", converter.Consumer(), 4);
    ...
    void test_converter_as_reader()
    {
        ...
        TestReader<int8_t> rd("hiq2realconverter_test_testreader", output, 8);
        HIq2RealConverter<int8_t> converter("hiq2realconverter_test_as_reader", &rd, 4);
