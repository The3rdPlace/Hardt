...
class HFirDecimator_Test: public Test
{
    ...
    private:
        ...
        void test_read_dont_collect()
        {
            ...
            HFirDecimator<int8_t> fdm(rd.Reader(), 4, coefs, 5, 12, false);
        ...
        void test_write_dont_collect()
        {
            ...
            HFirDecimator<int8_t> fdm(wr.Writer(), 4, coefs, 5, 12, false);
        ...
        void test_writerConsumer_dont_collect()
        {
            ...
            HFirDecimator<int8_t> fdm(srcWr.Consumer(), 4, coefs, 5, 12, false);
            TestWriter<int8_t> wr(fdm.Consumer(), 3);
