...
class HHahnWindow_Test: public Test
{
    public:
    ...
    private:
        ...
        void test_apply()
        {
            ...
            ASSERT_IS_EQUAL(output[2], (int8_t) 7);
            ASSERT_IS_EQUAL(output[3], (int8_t) 10);
            ASSERT_IS_EQUAL(output[4], (int8_t) 7);
            ASSERT_IS_EQUAL(output[5], (int8_t) 2);
        }
