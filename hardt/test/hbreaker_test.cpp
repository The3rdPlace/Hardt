...
class HBreaker_Test: public Test
{
    ...
    private:
        ...
        {
            TestWriter<int8_t> wr("hbreaker_test_testwriter", 8);
            int8_t input[8] = {10, 20, 30, 40, 50, 60, 70, 80};
            HBreaker<int8_t> off("hbreaker_test_as_writer", wr.Writer(), false, 6);
        ...
        void test_off_as_reader()
        {
            ...
            TestReader<int8_t> rd("hbreaker_test_testreader", output, 8);
            HBreaker<int8_t> off("hbreaker_test_off_as_reader", &rd, false, 6);
        ...
        void test_start_stop_as_writer()
        {
            ...
            TestWriter<int8_t> wr("hbreaker_test_testwriter", 8);
            HBreaker<int8_t> off("hbreaker_test_start_stop_as_writer", wr.Writer(), false, 6);
        ...
        void test_start_stop_as_reader()
        {
            ...
            int8_t output[8] = {10, 20, 30, 40, 50, 60, 70, 80};
            TestReader<int8_t> rd("hbreaker_test_testreader", output, 8);
            HBreaker<int8_t> off("hbreaker_test_start_stop_as_reader", &rd, false, 6);
