...
class HSubtracter : public HReader<T>, public HWriter<T>, public HWriterConsumer<T>
{
    ...
    public:
        ...
        HSubtracter(std::string id, HReader<T>* reader_1, HReader<T>* reader_2, size_t blocksize);

        /** Construct a new HSubtracter */
        HSubtracter(std::string id, HReader<T>* reader, HWriter<T>* writer, size_t blocksize);
         ...
         */
        HSubtracter(std::string id, HWriter<T>* writer, size_t blocksize);

        /** Construct a new HSubtracter */
        HSubtracter(std::string id, HReader<T>* reader, HWriterConsumer<T>* consumer, size_t blocksize);

        /** Construct a new HSubtracter */
        HSubtracter(std::string id, HWriterConsumer<T>* consumer, size_t blocksize);
